...
export function CompanySearch() {
  ...
  return (
    <Card className="p-6">
      <h1 className="text-2xl font-bold mb-2">Company Reviews & Discussions</h1>
      <p className="text-muted-foreground mb-6">Find reviews, work experiences, and recruitment insights</p>
