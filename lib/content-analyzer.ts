// Content analysis helper for detecting companies, skills, and industries in post content

// Common company names and variations
const KNOWN_COMPANIES = [
    ...
    "coca-cola", "pepsi", "unilever", "procter & gamble", "nestle",
    "heineken", "heineken group", "bmw", "mercedes", "volkswagen", "toyota", "honda",
    "samsung", "lg", "sony", "panasonic", "siemens", "bosch",
    "walmart", "target", "ikea", "zara", "h&m", "nike", "adidas", "puma",
];

// Common skills - tech + soft skills
const KNOWN_SKILLS = [
    ...
    "express", "django", "flask", "spring", "laravel", "rails", ".net",
    ...
    "presentation", "negotiation", "sales", "marketing", "analytics",
    "strategy", "planning", "organization", "time management",

    // Business Skills
    "data analysis", "business intelligence", "financial analysis", "accounting",
    "hr", "recruitment", "training", "customer service", "operations",
    "supply chain", "logistics", "procurement",

    // Design
    "ui design", "ux design", "graphic design", "figma", "sketch", "adobe xd",
    "photoshop", "illustrator", "branding", "web design",
];
...
export function calculateRelevanceScore(
    ...
    userPreferences.companies.forEach(companyId => {
        if (postAnalysis.detectedCompanies.some(detected =>
    ...
    postAnalysis.detectedIndustries.forEach(industry => {
        if (userIndustriesLower.some(userInd =>
            industry.toLowerCase().includes(userInd) ||
            userInd.includes(industry.toLowerCase())
        )) {
    ...
    if (authorProfile) {
        ...
        if (authorProfile.skills) {
            authorProfile.skills.forEach(authorSkill => {
                if (userPreferences.skills.some(userSkill =>
