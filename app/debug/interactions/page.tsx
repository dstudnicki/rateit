...
export default async function InteractionHistoryPage() {
    ...
    if (!session) {
        return (
            <div className="container max-w-4xl mx-auto py-8">
                <h1 className="text-2xl font-bold mb-4">Please login to see interaction history</h1>
            </div>
        );
    }
    ...
    return (
        <div className="container max-w-4xl mx-auto py-8 space-y-6">
            <div>
                <h1 className="text-3xl font-bold mb-2">Your Interaction History</h1>
                <p className="text-muted-foreground">
                    These interactions are used to personalize your content feed
                </p>
            </div>
            ...
            <div className="space-y-3">
                <h2 className="text-xl font-semibold">Recent Interactions (Last {sortedInteractions.length})</h2>
                {sortedInteractions.length === 0 ? (
                    <Card className="p-6">
                        <p className="text-muted-foreground text-center">
                            No interactions yet. Start liking posts and viewing companies!
                        </p>
                    </Card>
                ) : (
                    sortedInteractions.slice(0, 50).map((interaction, index) => {
                        const typeColor =
                            interaction.type === "like" ? "bg-blue-100 text-blue-800" :
                            interaction.type === "comment" ? "bg-green-100 text-green-800" :
                        ...
                        const targetIcon =
                            ...
                            interaction.targetType === "company" ? "🏢" :
                            "👤";
            ...
            <Card className="p-6 bg-blue-50 border-blue-200">
                ...
                <ul className="text-sm text-blue-800 space-y-1">
                    <li>• <strong>Likes & Comments:</strong> Posts/companies with similar keywords get boosted (+15-20 points)</li>
                    <li>• <strong>Views:</strong> Company views help us learn your industry preferences</li>
                    <li>• <strong>Time Window:</strong> Only last 30 days count (keeps recommendations fresh)</li>
                    <li>• <strong>Max Storage:</strong> We keep your last 100 interactions</li>
                </ul>
            </Card>
        </div>
    );
