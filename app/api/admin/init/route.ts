...
// Admin init route - disable static generation
        ...
        for (const email of adminEmails) {
            ...
            if (result.matchedCount > 0) {
                results.push({
                    ...
                    message: result.modifiedCount > 0 ? "Role set to admin" : "Already has admin role",
                });
            } else {
                results.push({
                    email,
            ...
            instructions: {
                ...
                success:
                    successCount > 0
                        ...
                        : null,
                alreadyAdmin: alreadyAdminCount > 0 ? "ℹ️ Some users already had admin role." : null,
